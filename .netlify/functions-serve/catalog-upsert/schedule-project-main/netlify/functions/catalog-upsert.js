...
// ../netlify/functions/catalog-upsert.js
var catalog_upsert_exports = {};
__export(catalog_upsert_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(catalog_upsert_exports);
    ...
    if (id) {
      ...
      result = await sql`
        INSERT INTO catalog_items (
          ...
          image_url, cloudinary_public_id, features
        ) VALUES (
          ${category}, ${title}, ${description}, ${price}, 
          ${image_url}, ${cloudinary_public_id}, ${features}
        )
...
//# sourceMappingURL=catalog-upsert.js.map
