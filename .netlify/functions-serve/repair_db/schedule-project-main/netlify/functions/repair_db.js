...
// ../netlify/functions/repair_db.js
var repair_db_exports = {};
__export(repair_db_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(repair_db_exports);
...
var handler = async () => {
  try {
    ...
    await sql`CREATE TABLE IF NOT EXISTS posts (id SERIAL PRIMARY KEY)`;
    ...
    try {
      ...
      console.log("Skipping doctors index (table might not exist yet)");
    }
    try {
      ...
      console.log("Skipping leave_data index (table might not exist yet)");
    }
...
//# sourceMappingURL=repair_db.js.map
